...
<input type="submit" [disabled]="!feedbackForm.valid" value="Leave
Feedback">
</fieldset>
</form>
<div class="feedback">
...
<h2>Rating: {{ feedback.rating }}</h2><h3>Likes:</h3>
<ul class="likes-list">
...
leaveFeedback() {
  // Get the boolean values for each checkbox from the FormArray const
  const selectedLikesValues = this.likesArray.value;

  // Map and filter the likes based on the boolean values const
